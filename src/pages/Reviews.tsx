            ...
            {[
              ...
              <Card key={index} className="glass border-primary/20 hover:shadow-elegant transition-smooth group cursor-pointer">
                <CardContent className="p-6">
                  <div className="aspect-video bg-gradient-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-gradient-primary/20 transition-smooth">
            ...
            {partnerLogos.map((partner, index) => (
              <Card key={index} className="glass border-primary/20 hover:shadow-elegant transition-smooth group cursor-pointer">
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 bg-gradient-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:bg-gradient-primary/20 transition-smooth">
