          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Revolutionary AI platform for modern investment solutions.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {homeTexts.footer.menu.map((item, index) => (
                  <li key={index}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {homeTexts.footer.social.map((social, index) => (
                  <li key={index}>
                    <Link to="#" className="text-muted-foreground hover:text-primary transition-smooth">
                      {social}
                    </Link>
